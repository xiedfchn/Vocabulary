...
$(document).ready(function(){
    ...
    // Get Theme_settings From LocalStorage
    var theme_settings = localStorage.getItem("theme_settings");
    ...
    // End Get Theme_settings From LocalStorage
    ...
    $(".theme-settings input").on("ifClicked",function(){
        ...
        // Save theme_settings to localStorage
        var temp = JSON.stringify(theme_settings)
        localStorage.setItem("theme_settings",temp);

        // End Save theme_settings to localStorage
